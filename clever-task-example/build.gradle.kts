...
dependencies {
    ...
    api("org.apache.flink:flink-streaming-java:1.20.3")
    api("org.apache.flink:flink-clients:1.20.3")
    api("org.apache.flink:flink-table-api-java:1.20.3")
    api("org.apache.flink:flink-table-runtime:1.20.3")
